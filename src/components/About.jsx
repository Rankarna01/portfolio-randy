          ...
          <div className="text-gray-400 py-4 space-y-2 md:space-y-2 md:pt-8 lg:pt-12 font-semibold text-justify">
            <AnimatedWrapper>
              <p className="leading-tight">
                Saya Seorang Mahasiswa IT di Salah Satu Perguruan Tinggi Vokasi Negeri Yang Ada Di Medan,
                Saya Memiliki Keterampilan Dan Bakat Di Bidang Desain Grafis DAn UI/UX
              </p>
            </AnimatedWrapper>
            <AnimatedWrapper>
              <p className="leading-tight">
                Selain itu Saya Juga Memiliki Keahlian dalam Pembuatan Website Yang dinamis dan Responsive, Saya Memiliki Beberapa Pengalaman
                Projek, Magang, Dan Freelance Yang Berhubungan dengan Pembuatan Website
              </p>
            </AnimatedWrapper>
            <AnimatedWrapper>
              <p className="leading-tight">
